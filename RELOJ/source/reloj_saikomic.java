...
public class reloj_saikomic extends PApplet {
...
public void setup() {
  ...
  ticksRadius = radius * 0.5f;
  numbersRadius = radius * 0.85f;
  secondsRadius = radius * 0.8f;
  minutesRadius = radius * 0.55f;
  hoursRadius = radius * 0.3f;
 ...
 */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "reloj_saikomic" };
    if (passedArgs != null) {
